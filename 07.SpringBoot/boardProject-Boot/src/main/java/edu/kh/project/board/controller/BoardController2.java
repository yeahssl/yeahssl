...
public class BoardController2 {
	...
	// 게시글 작성 화면 전환
	@GetMapping("/{boardCode:[0-9]+}/insert") // + : 한자리 이상을 의미 한다
	...
	public String boardInsert(
		...
		int boardNo = service2.boardInsert(board, images);
	...
	public String boardUpdate(
			@PathVariable("boardCode") int boardCode, // {boardCode} 자리에 들어오는 주소가 매개변수에 담김
...
//		if(로그인 회원번호 != 작성자 번호) redirect
	...
	public String boardUpdate(
		...
		// 3) 게시글 수정 서비스 호출
		int rowCount = service2.boardUpdate(board, images, deleteList);
	...
	public String boardDelete(
		...
		int result = service2.boardDelete(boardCode, boardNo);
