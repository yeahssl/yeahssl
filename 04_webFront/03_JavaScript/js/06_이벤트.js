...
console.log(document.getElementById('test2a').onclick); //undefined(초기화X), null(참조 X)
...
test3.addEventListener("click", function(e){
    ...
    // 현재 너비가 500px을 초과하면 너비/높이를 200px 초기화
...
for(let op of opList) {
    ...
    op.addEventListener('click', function(e) {
        result.innerText 
        = new Function("return " + Number(num1.value) + e.target.innerText 
        + Number(num2.value))();
        });
...
// form태그 기본 이벤트 제거 방법3 (표준 이벤트 모델)
