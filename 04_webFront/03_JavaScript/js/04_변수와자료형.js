...
console.log("(전역 변수) num1 : " + num1);
console.log("(전역 변수) num2 : " + num2);

function testFn(){
    var num3 = 3; // function 지역 변수
    num4 = 4;   // 전역 변수

    console.log("함수 내부에서 선언된  (함수 변수)num3 : " + num3);
    console.log("함수 내부에서 선언된  (전역 변수)num4 : " + num4);
...
console.log("함수 밖에서 (전역 변수)num4 : " + num4);
...
// -> 에러가 발생하지 않고 undefined로 출력됨

console.log(test);
var test = 10; // var로 변경하면 가능
console.log(test);
...
function typeTest() {
    ...
    box.innerHTML += "<br>heght : " + height + "/" + typeof height;
    ...
    // Java 객체 --> class에 작성된 내용대로, 메모리에(heap)에 할당
    // JS의 객체는 {K:V} Map형식
