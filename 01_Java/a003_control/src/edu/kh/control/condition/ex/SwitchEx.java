...
public class SwitchEx {
	...
	/* switch문 (swich - case문)
	 * - 식 하나의 결과로 많은경우의 수를 처리할 때 사용하는 조건문
...
//			res = "BLUE";
//	}
	   // 2) switch 버전 : 입력값이 확실하게 정해져 있는 경우에만 사용 
		switch(input) {
	...
	public void ex4() {
        ...
        switch(op) {
        case "+" :  
        	System.out.printf("%d %s %d = %d", num1, op, num3, num1+num3); break;
        case "-" :   
        	System.out.printf("%d %s %d = %d", num1, op, num3, num1-num3); break;
        case "*" :   
        	System.out.printf("%d %s %d = %d", num1, op, num3, num1*num3); break;
        ...
        case "/" : 
        	if(num3 == 0) {
				...
				System.out.printf("%d %s %d = %.3f", num1, op, num3, num1/num3);
			} break;
