...
public class APIView {
	...
	public void displayMenu() {
		 ...
		 do {
			 ...
			 System.out.println("4. String 특징, 문제점");
			 ...
			 try {
				 ...
				 sc.nextLine(); // 입력버퍼에 남이있는 잘못 입력된 문자열을 읽어와 없앰
			 
				 input = -1; // input값에 0이 아닌 값을 대입하여 while문이 종료되지 않게함
			 }
...
//	     System.out.println(s2.hashCode());
	...
	private void ex5() {
		...
		// StringBffer.capacity() : 현재 버퍼의 크기
		System.out.println(sb.capacity());
		System.out.println("현재 주소 : " + System.identityHashCode(sb));
		
		// StringBffer.append(문자열)
		// StringBffer 객체에 문자열을 기존 데이터 뒤에 붙임
		sb.append("abc");
		
		// StringBffer.toString()
		// - StringBffer에 저장된 문자열을 String 형태로 반환
		...
		// delete(int start, int end) : 삭제(start이상 end 미만) -> 시작과 끝을 지정하는 것은 대부분 마지막은 미포함
	...
	private void ex6() {
		...
		while(true) {
			...
			sb.append(str); // 입력받은 기존 한 줄 뒤에 추가 하겠다
	...
	private void ex7() {
		...
		double d = Double.parseDouble("3.14156487568") + 10.0;
	...
	private void ex8() {
		...
		SimpleDateFormat sdf3 = new SimpleDateFormat("yyyy년 MM월 dd 일 E요일 a hh시 mm분 ss초");
