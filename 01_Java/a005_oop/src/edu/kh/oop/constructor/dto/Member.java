...
public class Member {
	...
	// ** 오버로딩 **
	// - 한 클래스 내에 동일한 이름의 메서드를 여러 개 적성하는 기법
	...
	public Member(String memberId, int memberAge) {} // 성립 -> 자료형이 다름
	
	public Member(int memberAge, String memberId) {} // 성립 -> 입력 순서가 다름
	
	/*public Member(int memberAge, String memberName) {} // 오류 -> 컴퓨터는 자료형을 보고 판단*/
