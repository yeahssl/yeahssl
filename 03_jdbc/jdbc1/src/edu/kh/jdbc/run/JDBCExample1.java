...
public class JDBCExample1 {
	public static void main (String [] args) {
		...
		try {
			// **2단계 : 1단계에서 선언한 참조 변수에 알맞는 객체 대입
			...
			// -> 메모리의 객체가 생성되고 Connection을 이용한 DB 연결시
			//    이를 자동으로 참조한다.
			...
			String user = "kh_lys"; // 계정명
			
			String pw = "oracle_lys5034A"; // 비밀번호
...
//				java.sql.Date hireDate = rs.getDate("HIRE_DATE");
			...
			// 생성 순서 : conn, stmt, rs
			// close 순서 : rs, stmt, conn --> 생성 역순으로 닫아줌
