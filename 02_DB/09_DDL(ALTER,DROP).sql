...
--> DEPT_ID, LOCATION_ID에만 NOT NULL 제역조건 설정됨
...
-- ALTER TABLE DEPT_COPY ADD CONSTRAINT CHK_DEPT_COPY CHECK(컬럼명 비교연산자 값);
...
ALTER TABLE DEPT_COPY DROP CONSTRAINT SYS_C007520;
--> NOT NULL 제약조건 ADD는 안되는데 DROP은 가능

-- NOT NULL 제거 시 MODIFY 사용
ALTER TABLE DEPT_COPY MODIFY DEPT_TITLE CONSTRAINT SYS_C007520 /*NOT*/ NULL;
