...
-- ORA-01400: NULL을 ("KH_LYS"."DEPT_COPY2"."DEPT_TITLE") 안에 삽입할 수 없습니다
...
WHERE TEST_ID = 'TEST500000'; -- 27ms / 21ms / 21ms  

-- 인덱스 사용 O 조회
SELECT * FROM TB_INDEX_TEST
WHERE TEST_NO = 500000; -- 2/ 1/ 1  
