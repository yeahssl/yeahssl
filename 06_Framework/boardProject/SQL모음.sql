...
-- user01의 비밀번호 변경
UPDATE "MEMBER" SET
MEMBER_PW = '$2a$10$v/Yhj0NAuNqUlZsZIwbLiObJeSnFdSZ97yNfgT0cn5aXD1XR0qM16';
...
UPDATE "MEMBER" SET
MEMBER_PW = '$2a$10$y/iRq2/CHPHsWz4.ecmTBOT8SzbiLPWWoL46goT2PASN83IUi9dmS'
WHERE MEMBER_NO = '1';
...
VALUES(SEQ_IMG_NO.NEXTVAL, '/resources/images/board/',
		'20230508115013_00001.jpg', 'dog1.jpg', 0, 1498);
	
INSERT INTO BOARD_IMG
VALUES(SEQ_IMG_NO.NEXTVAL, '/resources/images/board/',
		'20230508115013_00002.jpg', 'dog2.jpg', 0, 1497);
	
INSERT INTO BOARD_IMG
VALUES(SEQ_IMG_NO.NEXTVAL, '/resources/images/board/',
		'20230508115013_00003.jpg', 'dog3.jpg', 0, 1496);
	
INSERT INTO BOARD_IMG
VALUES(SEQ_IMG_NO.NEXTVAL, '/resources/images/board/',
		'20230508115013_00004.jpg', 'dog4.jpg', 0, 1495);
	
INSERT INTO BOARD_IMG
VALUES(SEQ_IMG_NO.NEXTVAL, '/resources/images/board/',
		'20230508115013_00005.jpg', 'dog5.jpg', 0, 1494);
...
-- 회원 프로필 이미지 변경
UPDATE "MEMBER" SET
PROFILE_IMG = '/resources/images/member/cat3.jpg'
WHERE MEMBER_NO = 1;
...
FROM(
	...
	SELECT '웹접근경로' IMG_PATH, '변경명' IMG_RENAME, '원본명' IMG_ORIGINAL,
		   0 IMG_ORDER, 3001 BOARD_NO
	FROM DUAL
	
	UNION ALL
	
	SELECT '웹접근경로' IMG_PATH, '변경명' IMG_RENAME, '원본명' IMG_ORIGINAL,
		   1 IMG_ORDER, 3001 BOARD_NO
	FROM DUAL
	
	UNION ALL
	
	SELECT '웹접근경로' IMG_PATH, '변경명' IMG_RENAME, '원본명' IMG_ORIGINAL,
		   2 IMG_ORDER, 3001 BOARD_NO
	FROM DUAL
...
-- 4501, 4502 댓글 삽입 됨
INSERT INTO "COMMENT"
VALUES(SEQ_COMMENT_NO.NEXTVAL, '부모 댓글 1', DEFAULT, DEFAULT, 3005, 1, NULL);

INSERT INTO "COMMENT"
VALUES(SEQ_COMMENT_NO.NEXTVAL, '부모 댓글 2', DEFAULT, DEFAULT, 3005, 1, NULL);



-- 자식 댓글 삽입(4501번 부모댓글)
INSERT INTO "COMMENT"
VALUES(SEQ_COMMENT_NO.NEXTVAL, '자식 댓글 1-1', DEFAULT, DEFAULT, 3005, 1, 4501);

-- 자식 댓글 (2-1번 4506번)
INSERT INTO "COMMENT"
VALUES(SEQ_COMMENT_NO.NEXTVAL, '자식 댓글 1-2', DEFAULT, DEFAULT, 3005, 1, 4501);
INSERT INTO "COMMENT"
VALUES(SEQ_COMMENT_NO.NEXTVAL, '자식 댓글 1-3', DEFAULT, DEFAULT, 3005, 1, 4501);

-- 자식 댓글 삽입(4502번 부모댓글)
INSERT INTO "COMMENT"
VALUES(SEQ_COMMENT_NO.NEXTVAL, '자식 댓글 2-1', DEFAULT, DEFAULT, 3005, 1, 4502);
INSERT INTO "COMMENT"
VALUES(SEQ_COMMENT_NO.NEXTVAL, '자식 댓글 2-2', DEFAULT, DEFAULT, 3005, 1, 4502);

-- 2-1번자식의 자식 댓글
INSERT INTO "COMMENT"
VALUES(SEQ_COMMENT_NO.NEXTVAL, '자식의 자식 댓글', DEFAULT, DEFAULT, 3005, 1, 4506);
...
SELECT ROWNUM,BOARD_NO FROM BOARD
WHERE ROWNUM <=20
ORDER BY BOARD_NO DESC;
