...
if (updateInfo != null) {
    ...
    initNickname = memberNickname.value; // 초기 닉네임
    initTel = memberTel.value; // 초기 전화번호

    // 닉네임 유효성 검사
    memberNickname.addEventListener("input", () => {

        // 초기(변경전) 닉네임과 입력값이 같을 경우
...
let initCheck; // 초기 프로필이미지 상태를 저장하는 변수
                // false == 기본 이미지, ture == 이전 업로드 이미지 
